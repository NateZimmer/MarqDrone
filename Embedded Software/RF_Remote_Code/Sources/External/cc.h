...
#define LED_PxOUT         GPIOB_PDOR 	//P2OUT
#define LED_PxDIR         GPIOB_PDDR 	//P2DIR
#define LED1              (0x0004u)		//BIT2
#define LED2              (0x0020u)		//BIT5

#define GDO0_PxOUT        GPIOD_PDOR	//P2OUT
#define GDO0_PxIN         GPIOD_PDIR	//This is odd, but read PDIR in order to swee pin status.
#define GDO0_PxDIR        GPIOD_PDIR	//P2DIR
//#define GDO0_PxIE         P2IE			// TODO
//#define GDO0_PxIES        P2IES			// TODO
//#define GDO0_PxIFG        P2IFG			// TODO
#define GDO0_PIN          	(0x1<<4)		// PTD4
#define GDO2_PIN			(0x1<<5)

#define CSn_PxOUT         GPIOD_PDOR	//P1OUT
#define CSn_PxDIR         GPIOD_PDIR	//P1DIR
#define CSn_PIN           (0x0008u)		//BIT3

// SPI Pin Definitions
#define SPI_USCIB0_PxSEL  P1SEL			// TODO
#define SPI_USCIB0_PxSEL2 P1SEL2		// TODO
#define SPI_USCIB0_PxDIR  GPIOA_PDDR	//P1DIR
#define SPI_USCIB0_PxIN   GPIOA_PDIR	//P1IN
#define SPI_USCIB0_SIMO   (0x0080u)		//BIT7
#define SPI_USCIB0_SOMI   (0x0040u)		//BIT6
#define SPI_USCIB0_UCLK   (0x0020u)		//BIT5
